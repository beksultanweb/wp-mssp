...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240420_mssp_global_2e34a046bc6d7fea2748_20240420144002_archive.zip';
        const ARCHIVE_SIZE       = '144487283';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '2e34a04-20144002';
        const SECONDARY_PACKAGE_HASH = '8b61b0a-20144002';
        const VERSION            = '1.5.5';
